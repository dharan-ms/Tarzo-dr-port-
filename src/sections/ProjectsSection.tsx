      ...
      >
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 sm:grid-cols-[40%_60%] sm:gap-5 md:gap-6">
          <div className="flex min-h-0 flex-col gap-4 sm:gap-5 md:gap-6">
            ...
            <div
              className="relative min-h-0 flex-1 overflow-hidden rounded-[40px] sm:rounded-[50px] md:rounded-[60px]"
          ...
          <div className="relative min-h-[280px] overflow-hidden rounded-[40px] sm:min-h-0 sm:rounded-[50px] md:rounded-[60px]">
            <img
              src={project.col2}
              alt=""
              className="absolute inset-0 h-full w-full object-cover object-center"
